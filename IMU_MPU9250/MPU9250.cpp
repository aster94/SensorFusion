...
unsigned int MPU9250::IMU_wai(){
    unsigned int response;
    response = WriteReg(MPUREG_WAI|READ_FLAG, 0x00);
    return response;
}
...
uint8_t MPU9250::AK8963_wai(){
    uint8_t response;
    WriteReg(MPUREG_I2C_SLV0_ADDR,AK8963_I2C_ADDR|READ_FLAG); //Set the I2C slave addres of AK8963 and set for read.
    WriteReg(MPUREG_I2C_SLV0_REG, AK8963_WAI); //I2C slave 0 register address from where to begin data transfer
